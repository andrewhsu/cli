...
import (
	...
	deleteCmd "github.com/andrewhsu/cli/v2/pkg/cmd/alias/delete"
	listCmd "github.com/andrewhsu/cli/v2/pkg/cmd/alias/list"
	setCmd "github.com/andrewhsu/cli/v2/pkg/cmd/alias/set"
