...
import (
	...
	cmdList "github.com/andrewhsu/cli/v2/pkg/cmd/secret/list"
	cmdRemove "github.com/andrewhsu/cli/v2/pkg/cmd/secret/remove"
	cmdSet "github.com/andrewhsu/cli/v2/pkg/cmd/secret/set"
